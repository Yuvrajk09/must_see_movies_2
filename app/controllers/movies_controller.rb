class MoviesController < ApplicationController
  ...
  def index
    ...
    @movies = @q.result(:distinct => true).includes(:movie, :director_detail, :actor_details, :review_details, :bookmark_statuses).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def movie_params
      params.require(:movie).permit(:movie_id, :movie_name, :movie_description, :movie_duration, :movie_year)
    end
end
